...
public class ParametroController {
	...
	public List<ParametroEntity> findByNomeConstante(@PathVariable("constante") String constante){
		List<ParametroEntity> retorno = parametroRepository.findByNomeConstante(constante);
